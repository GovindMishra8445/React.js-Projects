...
const VendorDashboardCharts = () => {
  return (
    <div className="flex flex-col lg:flex-row gap-4 p-4 md:p-6 font-sans">
      
      {/* LEFT CARD - Sales Value */}
      <div className="bg-[#263348] text-white rounded-lg shadow-md p-4 md:p-5 w-full lg:w-[670px] h-[400px] md:h-[510px]">
      ...
      {/* RIGHT CARD - Orders */}
      <div className="bg-white rounded-lg shadow-md p-4 md:p-5 w-full lg:w-[350px] h-[400px] md:h-[510px]">
